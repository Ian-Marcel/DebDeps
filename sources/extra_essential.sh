...
## non-essential primordial dependencies v2
packages=(
    # ============================================================================
    ...
    # ============================================================================
    # GRAPHICS LIBRARIES (for containers with GUI apps)
    # ============================================================================
    libgl1-mesa-dri
    libglu1-mesa
    libglx-mesa0
    ...
    # ============================================================================
    # X11 LIBRARIES & UTILITIES (deprecated)
    # ============================================================================
    # libx11-dev
    # libxext-dev
    # libxrender-dev
    ...
    # ============================================================================
    # DEVELOPMENT LIBRARIES - SYSTEM & CONTAINER-SPECIFIC
    # ============================================================================
    libglib2.0-dev
    libsystemd-dev
    libpam0g-dev
